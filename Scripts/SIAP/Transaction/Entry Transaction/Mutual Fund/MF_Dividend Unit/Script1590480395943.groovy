...
WebUI.click(findTestObject('Transaction/Entry Transaction/Mutual Fund/MF_Dividend Unit/span_SIAP'))
...
WebUI.setText(findTestObject('Transaction/Entry Transaction/Mutual Fund/MF_Dividend Unit/input_Instruction No_ctl00ContentPlaceHolde_197de0'), 'EQ12')
...
WebUI.setText(findTestObject('Transaction/Entry Transaction/Mutual Fund/MF_Dividend Unit/input_Units_ctl00ContentPlaceHolder1pnlAlltxtUnits'), '1000')

WebUI.setText(findTestObject('Transaction/Entry Transaction/Mutual Fund/MF_Dividend Unit/textarea_Remarks_ctl00ContentPlaceHolder1pn_7a439a'), 'Testing Katalon')
